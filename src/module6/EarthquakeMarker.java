...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker>
{
	...
	public int compareTo(EarthquakeMarker other) {
		...
		// current magnitude is larger than what is being compared to 
		if (this.getMagnitude() > other.getMagnitude()) {
			return -1;
		} 
		
		// current magnitude is smaller than what is being compared to 
		else if (this.getMagnitude() < other.getMagnitude()) {
			return 1;
		} 
		
		// current magnitude is equal than what is being compared to 
		else {
			return 0;
		}
