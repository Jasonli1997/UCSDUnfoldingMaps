...
public class CityMarker extends CommonMarker {
	...
	public void drawMarker(PGraphics pg, float x, float y) {
		...
		// If the CityMarker is set to "clicked" then there will be a popup menu
		if (clicked) {
			// Save previous drawing style
			pg.pushStyle();
			
			// Draw a popup menu on the map about city information
			pg.fill(255, 250, 240);
			
			int xbase = 25;
			int ybase = 400;
			pg.rect(xbase, ybase, 230, 150);
			
			pg.fill(0);
			pg.textAlign(pg.LEFT, pg.CENTER);
			pg.textSize(12);
			pg.text("City Information", xbase+50, ybase+25);
			pg.text("Number of Nearby Earthquakes: " + getEarthquakes(), xbase+10, ybase+50);
	...
	private String getEarthquakes() {
		Integer countInt = (Integer) getProperty("EarthquakeCount");
